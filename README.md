...
| :--- | :--- | :--- | :--- |
| **Cognitive** | **[VEX Protocol](https://github.com/provnai/vex)** | Core Rust framework (13 crates) providing trust primitives for AI. | `LIVE` (v0.1.7) |
...
| **Studio** | **Agentic Studio** | Visual development environment for building and monitoring agents. | `BETA` |
| **Settlement** | **Verifiable Settlement** | API and decentralized Arweave batching for verifiable anchoring. | `BETA` |
| **Environment** | **Action Attestation** | OS-level action monitoring via hardware keys and ZK-STARKs. | `BETA` |
| **Interception** | **Cognitive Interceptor** | Real-time security proxy and verification buffer for agent tooling. | `BETA` |
